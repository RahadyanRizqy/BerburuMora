...
bgsrc = 'contents/dawnwinery.png'
mrsrc = 'contents/mora.png'
chsrc = 'contents/diluc.png'
hisrc = 'contents/hilichurl.png'

program = Tk()
program.resizable(width = False, height = False)
program.title("Diluc Mengumpulkan Mora Di Rumahnya")
...
mora1 = Props(mrsrc, 500, 625, NW)
mora2 = Props(mrsrc, 800, 500, NW)
mora3 = Props(mrsrc, 825, 225, NW)
mora4 = Props(mrsrc, 500, 100, NW)
mora5 = Props(mrsrc, 50, 100, NW)
mora6 = Props(mrsrc, 450, 450, NW)
mora7 = Props(mrsrc, 10, 350, NW)
mora8 = Props(mrsrc, 1100, 600, NW)
mora9 = Props(mrsrc, 250, 20, NW)
mora10 = Props(mrsrc, 1100, -10, NW)
hilichurl1 = Props(hisrc, 1215, 300, NW)
hilichurl2 = Props(hisrc, 700, 10, NW)
hilichurl3 = Props(hisrc, 300, 200, NW)
hilichurl4 = Props(hisrc, 200, 500, NW)
hilichurl5 = Props(hisrc, 900, 500, NW)
...
def start():
    ...
    try:
        while True:
            ...
            if char.coords()[1] >= h-char.ybrake()-17 or char.coords()[1] < 1:
                chary_speed = -chary_speed

            if hilichurl1.coords()[1] > 550 or hilichurl1.coords()[1] < 299:
                hili1y_speed = -hili1y_speed
            if hilichurl2.coords()[0] > 1100 or hilichurl2.coords()[0] < 495:
                 hili2x_speed = -hili2x_speed
            if hilichurl3.coords()[1] > 201 or hilichurl3.coords()[1] < 5:
                hili3y_speed = -hili3y_speed
            if hilichurl4.coords()[0] > 470 or hilichurl4.coords()[0] < 175:
                hili4x_speed = -hili4x_speed
            if hilichurl5.coords()[0] > 1090 or hilichurl5.coords()[0] < 791:
